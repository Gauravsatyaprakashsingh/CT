...
<div class="content-wrapper">
  <div class="row">
    <div class="col-12 grid-margin">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title"><?=( $editUser )?'Edit User':'New User'?></h4>
          <?php $actionUrl = ( $editUser )?base_url('Users/update_user'):base_url('Users/save_user') ?>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input name="fullname" value="<?=( $editUser )?$userData->fullname:''?>"  placeholder="Enter full name" type="text" class="form-control" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input name="email" value="<?=( $editUser )?$userData->email:''?>" placeholder="Enter email" type="text" class="form-control" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input name="contact" value="<?=( $editUser )?$userData->contact:''?>" placeholder="Enter contact" type="text" class="form-control" />
                  </div>
                </div>
              </div>
            </div>
...
<?php endif; ?>
            ...
            <div class="row">
              <button type="submit" class="btn btn-info" ><?=($editUser)?'Update':'Save'?></button>
            </div>
