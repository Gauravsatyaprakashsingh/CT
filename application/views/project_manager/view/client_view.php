...
?>
<form id="userForm" action="<?=base_url('Users/edit_client')?>" method="post">
              ...
              <tbody>
                <?php $counter = 1; foreach ($tableData as $key => $value): ?>
                  <tr>
                    ...
                    <td>
                      <button  title="Edit User" onclick="edit_client( '<?=$value->id?>' )" class="btn btn-icons btn-rounded btn-info" type="button" name="button">
...
<script type="text/javascript">
  ...
  function edit_client( user_value ){
