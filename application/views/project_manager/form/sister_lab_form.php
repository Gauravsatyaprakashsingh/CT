    ...
    <div class="col-12 grid-margin">
      <div class="card">
        <div class="card-body">
             ...
             foreach( $clientDatas as $clientDatass ) {
                       $clientData = $clientDatass;
                     
                    }
                    }?>
          <h4 class="card-title"><?=( $editClient )?'Edit Client':'New  SisterLab '?></h4>
          <?php $actionUrl = ( $editClient )?base_url('Sisterlab/edit_sisterLab'):base_url('Sisterlab/save_sisterlab') ?>
          <form action="<?=$actionUrl?>" method="post" class="form-sample">
            <?php if( $editClient): ?>
            <input type="hidden" name="userValue" value="<?=$clientData->sis_id?>">
            <?php endif; ?>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input name="fullname"  value="<?=( $editClient )?$clientData->sis_name:''?>"   placeholder="Enter full name" type="text" class="form-control" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input name="password" placeholder="Enter password" value="<?=( $editClient )?$clientData->sis_password:''?>" type="text" class="form-control" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input name="email" value="<?=( $editClient )?$clientData->sis_email:''?>" placeholder="Enter email" type="text" class="form-control" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input name="contact" value="<?=( $editClient )?$clientData->sis_contact:''?>" placeholder="Enter contact" type="text" class="form-control" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                 <input name="Location_area" value="<?=( $editClient )?$clientData->sis_area:''?>" placeholder="Enter Location Area" type="text" class="form-control" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input name="Location_address" value="<?=( $editClient )?$clientData->sis_address:''?>" placeholder="Enter Location Address" type="text" class="form-control" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input name="pincode"  value="<?=( $editClient )?$clientData->sis_pincode:''?>"   placeholder="Enter pincode" type="text" class="form-control" />
                  </div>
                </div>
              </div>
              <!--<div class="col-md-6">-->
