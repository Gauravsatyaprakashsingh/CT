...
<body>
            ...
            <?php if($this->session->flashdata('success')): ?>
              <script>
                swal("SUCCESSFULLY", "<?=$this->session->flashdata('success')?>", "success");
              </script>
            <?php endif;   ?>

          <?php if($this->session->flashdata('error')): ?>
            <script>
              swal("Invalid Login", "Please check your username and password and try again", "warning");
            </script>
          <?php endif;   ?>
            ...
            <div class="auto-form-wrapper">
              <form action="<?=base_url('Login/admin')?>" method="post">
                ...
                <div class="form-group d-flex justify-content-between">
                  ...
                  <a href="<?=base_url('Login/forget_password')?>" class="text-small forgot-password text-black">Forgot Password</a>
                </div>
                <!-- <div class="form-group">
