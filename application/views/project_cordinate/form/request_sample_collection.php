...
<div class="content-wrapper">
  <form class="" id="forms" action="<?=base_url('Samples/saveVisit')?>" enctype="multipart/form-data" method="post">
    <?php if( $hiddenField ): ?>
            ...
            <div class="row" >
              ...
              <div class="col-md-4">
                 ...
                 <div class="col-md-4">
						...
						<div class="col-md-4">
						<div class="form-group row">
						<label class="col-sm-4 col-form-label">City<strong style="color:red;">*</strong></label>
						<div class="col-sm-8">
						<select class="form-control" name="city2" onchange="city_sample()" id="statess_id">
						...
						<div class="col-sm-8">
						<select class="form-control" name="city3" onclick="walkSample_Lap()" id="Location_id">
              ...
              <div class="col-md-4 date_hidden" id="date_hidd">
                            ...
                            <div class="col-md-4 date_hidden" >
                              <div class="form-group row">
                                <label class="col-sm-4 col-form-label">Select Representative User <strong style="color:red;">*</strong></label>
                                <div class="col-sm-8">
                                  <select id="representativeUserList" onchange="selectUser()" class="form-control" name="">
...
function city_sample()
{
	 var state_name = document.getElementById('state_names').value;
     var city_name = document.getElementById('statess_id').value;
	 var id = document.getElementById('Location_id');
     var requestUrl = "<?=base_url('Samples/locationSample_walkin?text_name=');?>"+state_name+'&city_name='+city_name;
     ...
     xhttp.onreadystatechange = function() 
	 {
       if (this.readyState == 4 && this.status == 200) 
	   {
          ...
          var option = document.createElement('option');
          option.id = 'opt_id';
          var textNode = document.createTextNode(value.location_name);
          var textNodes = document.createTextNode(value.Location_name);
          id.appendChild( option );
		  console.log(option.appendChild(textNode));
		  });
        }
  ...
  function clearPreviousForm(){
     ...
     var representative = getRepresentationUser( id );
  ...
  function selectUser( ){
    var dataset = { };
    var e = document.getElementById("representativeUserList");
    var strUser = e.options[e.selectedIndex].value;
    var requestUrl = "<?=base_url('Api/selected_user')?>";
     var xhttp = new XMLHttpRequest();
     xhttp.onreadystatechange = function(){
         if( this.readyState == 4 && this.status == 200 ){
             console.log( JSON.parse(this.responseText) );
             var resp = JSON.parse( this.responseText );
             document.getElementById('r2').value = resp.fullname;
             document.getElementById('r1').value = resp.contact;
             document.getElementById('remail').value = resp.email;
         }
     };
     xhttp.open("POST", requestUrl , true);
     xhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
     xhttp.send( "user_id="+strUser );
  }

  function getRepresentationUser( project_id ){
     var requestUrl = "<?=base_url('Api/repersentative_user')?>";
	 $("#representativeUserList").empty();
     var xhttp = new XMLHttpRequest();
     xhttp.onreadystatechange = function(){
         if( this.readyState == 4 && this.status == 200 ){
             console.log( JSON.parse(this.responseText) );
             ...
             resp.forEach((value)=>{
                ...
                var t = document.createTextNode( value.fullname);
                x.appendChild(t);
                document.getElementById("representativeUserList").appendChild(x);
              });
