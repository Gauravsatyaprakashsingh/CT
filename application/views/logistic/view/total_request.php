              ...
              <tbody>
                <?php $counter = 1;  foreach ($tableData as $key => $value):  ?>
                  <tr>
                    ...
                    <?php if ( $userType== 19 ): ?>
                      <td><?=$value->Logistic_name?></td>
                      <td><?=$value->logistic_contact?></td>
                      <!-- <td>Phlebo Email</td> -->
                    <?php endif; ?>
                  ...
                  <td>
                   <?php
                    ...
                    <a href="<?=base_url('Logistic_sister/phelbo_Reached?id=').$value->visit_id?>" title="Reached at Client"  class="btn btn-rounded btn-info ">Reached at Client</a><?php }?>
                     <a href="<?=base_url('Request/request_detail?value=').$value->visit_id?>" class="btn btn-rounded btn-info" >View</a>
                  ...
                  <td>
                    ...
                    <!--<a href="<?//=base_url('Logistic_sister/phelbo_Delivered?id=').$value->visit_id?>" title="Sample Delivered" class="btn btn-rounded btn-info">Sample Delivered</a>-->
                  <?php }
                  else{
