      ...
      <div class="card">
        <div class="card-body">
		 ...
		 <?php if($type == 4){?>
		  ...
		  <a href="<?=base_url('Samples/add_patient?id=').$unique_id?>" title="Add Patient" class="btn btn-primary ">Add Patient</a>
		 ...
		 <?php } ?>
          ...
          <div class="table-responsive">
			...
			<a style="width:150px;height:28px;color:#FFF;padding:5px 3px;
			text-align:center;top:0;position:absolute;right:0;margin-right:20px;margin-top:20px" 
			href="<?=base_url('Sister_Request/phelbo_Delivered?id=').$ids?>" title="Sample Delivered" class="btn  btn-info ">Sample Delivered</a>
