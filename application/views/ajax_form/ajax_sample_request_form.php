            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input name="patient_name[]" placeholder="Enter patient name" type="text" class="form-control" required />
              ...
              <div class="col-md-4">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="ages[]" placeholder="Enter Age"  class="form-control" />
                  </div>
                </div>
              </div>
              <div class="col-md-4">
              ...
              <div class="col-md-4">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input name="contact[]" id="contact3" placeholder="Enter contact number of patient" type="text" class="form-control" required/>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input name="email[]" placeholder="Enter email of patient" type="text" class="form-control" required/>
                  </div>
                </div>
              </div>
